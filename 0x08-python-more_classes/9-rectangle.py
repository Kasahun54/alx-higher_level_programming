...
class Rectangle:
    ...
    Attributes:
        number_of_instances (int): a number of Rectangle instances
    ...
    def bigger_or_equal(rect_1, rect_2):
        """Return a Rectangle with a greater area

        Args:
            rect_1 (Rectangle): a first Rectangle
            rect_2 (Rectangle): a second Rectangle
        Raises:
            TypeError: If eiar of rect_1 or rect_2 is not a Rectangle
        """
    ...
    def square(cls, size=0):
        ...
        Args:
            size (int): a width and height of a new Rectangle
        """
