...
""" The Module for test Rectangle class """
import unittest
...
class TestRectangleMethods(unittest.TestCase):
    ...
    def test_new_rectangle_2(self):
        """To Test new rectangle with all attrs """
    ...
    def test_is_Base_instance(self):
        """ To Test Rectangle is a Base instance """
        new = Rectangle(1, 1)
        self.assertEqual(True, isinstance(new, Base))

    def test_incorrect_amount_attrs(self):
        """ To Test error raise with 1 arg passed """
    ...
    def test_area(self):
        """ That Checking the return value of area method """
        new = Rectangle(4, 5)
    ...
    def test_dict_to_json(self):
        """ Test the Dictionary to JSON string """
        r1 = Rectangle(2, 2)
