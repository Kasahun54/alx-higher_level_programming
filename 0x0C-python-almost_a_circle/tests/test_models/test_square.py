...
class TestSquareMethods(unittest.TestCase):
    ...
    def test_new_square_2(self):
        """To Test new square with all attrs """
        new = Square(2, 5, 5, 4)
    ...
    def test_str(self):
        """ That Test __str__ return value """
        r1 = Square(4, 2, 2)
        res = "[Square] (1) 2/2 - 4\n"
        with patch('sys.stdout', new=StringIO()) as str_out:
            print(r1)
    ...
    def test_dict_to_json(self):
        """That Test Dictionary to JSON string """
        s1 = Square(2)
    ...
    def test_value_square(self):
        """ That Test value pased to Square """
        with self.assertRaises(ValueError):
            s1 = Square(-1)

    def test_create(self):
        """That Test create method """
        dictionary = {'id': 89}
